...
//On Debian I installed libgtest-dev libgtest0 from apt, likely Mint can do the same.
...
TEST(IOManager, CanCreateManager)
{
  IOManager io;
}
 ...
 * (null-terminated strings are equal, not equal, equal ignoring case, not equal ignoring case)
 */
